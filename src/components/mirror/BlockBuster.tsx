...
import { Lightbulb, Sparkles, ArrowRight, TrendingUp, Repeat, Flame, Zap } from "lucide-react";
                ...
                >
                  ...
                  <div className="relative flex-1">
                    <div className="flex items-center justify-between mb-3">
                      <span className={`text-[9px] px-2 py-1 rounded-full font-medium ${engagementColors[idea.estimatedEngagement]}`}>
